...
//APPEND END""",
    "compile": {
        ...
        "max_real_time": 5000,
        "max_memory": -1,
        "compile_command": "/usr/bin/mcs {src_path} -out:{exe_dir}/Main.exe -codepage:65001"
    },
    "run": {
        "command": "/usr/bin/mono {exe_dir}/Main.exe",
        "seccomp_rule": None,
        "env": default_env,
        "memory_limit_check_only": 1
    }
...
languages = [
    ...
    {"config": _csharp_lang_config, "name": "C#", "description": "Mono JIT 4.6.2", "content_type": "text/x-csharp"},
    ...
    {"config": _pascal_lang_config, "name": "Pascal", "description": "Pascal 3.0.4", "content_type": "text/x-pascal"},
]
